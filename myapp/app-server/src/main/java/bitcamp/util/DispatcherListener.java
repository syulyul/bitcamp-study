...
public class DispatcherListener implements ActionListener {
  ...
  public DispatcherListener() throws Exception {
    ...
    beanContainer.put("member/updatee", new MemberUpdateListener(memberDao, sqlSessionFactory));
    ...
    beanContainer.put("board/updatee", new BoardUpdateListener(1, boardDao, sqlSessionFactory));
    ...
    beanContainer.put("reading/updatee", new BoardUpdateListener(2, boardDao, sqlSessionFactory));
