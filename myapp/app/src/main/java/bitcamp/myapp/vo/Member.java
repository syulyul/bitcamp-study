...
public class Member {
  ...
  // Object의 equals()는 Member 인스턴스를 비교한느데 적하지 않다.
  ...
  public boolean equals(Object obj) {
    ...
    // 위 조건에서 this가리키는 인스턴스의 클래스와
    // 파라미터 obj가 가리키는인스턴스의 클래스가
    ...
    // }
    //
    // if (this.getName() != null && !this.getEmail().equals(m.getEmail())) {
    // return false;
    // }
    //
    // if (this.getName() != null && !this.getPassword().equals(m.getPassword())) {
    // return false;
    // }
    //
