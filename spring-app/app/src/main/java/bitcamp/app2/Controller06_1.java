...
public class Controller06_1 {
  ...
  public void error1() throws Exception {
    throw new Exception("request handler 에서 Exception 발생!");
  ...
  public void error() throws Exception {
    throw new IOException("request handler 에서 IOException 발생!");
  }
  ...
  public void error3() throws Exception {
    throw new SQLException("request handler 에서 SQLException 발생!");
  }
