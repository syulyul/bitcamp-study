...
- Queue 적용
  - MenuPrompt 클래스에 메뉴 출력 기능을 추가
    - App, BoardHandler, MemberHandler, ItemHandler 변경
...
- Command 패턴을 활용하여 메뉴 기능 구현하기
  - BoardHandler, MemberHandler, ItemHandler에 적용
    - Command 인터페이스 정의
    - BoardXxxCommand, MemberXxxCommand, ItemXxxCommand 클래스로 분해
...
- CSV 데이터 생성을 Board, Item, Member 클래스에 맡기기
  - Information Expert 패턴 적용
- CSV 데이터를 가지고 Board, Item, Member 클래스 생성하기
