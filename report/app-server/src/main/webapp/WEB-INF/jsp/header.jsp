...
<div style='height: 50px;background-color:#c2e0f0;'>
    ...
    <a href='/app/board/list?category=2'>공지사항</a>
...
<c:choose>
    ...
    <c:otherwise>
        ...
        <c:if test="${not empty sessionScope.loginUser.photo}">
            <img src='http://urnfabxxeceu19010753.cdn.ntruss.com/member/${loginUser.photo}?type=f&w=30&h=40&faceopt=true&ttype=jpg'>
        </c:if>
