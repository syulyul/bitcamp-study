...
public class ServerApp {
  ...
  private void prepareMenu() {
    ...
    noticeMenu.add(new Menu("notice/add", "등록", facadeListener));
    noticeMenu.add(new Menu("notice/list", "목록", facadeListener));
    noticeMenu.add(new Menu("notice/detail", "조회", facadeListener));
    noticeMenu.add(new Menu("notice/update", "변경", facadeListener));
    noticeMenu.add(new Menu("notice/delete", "삭제", facadeListener));
